      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-center text-black">
        ...
        <div className="max-w-md w-full mx-auto bg-white shadow-md rounded-lg p-8">
          ...
          <div className="w-full items-center flex justify-center">
            ...
            <Link href={`https://res.cloudinary.com/dxqwqe7me/image/upload/v1711878817/${student.certificate_url}.pdf`} type="application/pdf" download={`${student.name}.pdf`} target="_blank">
              <button
              className="bg-blue-500 text-white py-2 px-4 rounded mt-4 "
